<!--
  ╔══════════════════════════════════════════════════════════════╗
  ║   GitHub Profile README — Abel Sebastián Gómez Condo         ║
  ║   Version 2.0 — MAXIMUM ANIMATIONS EDITION                   ║
  ║   Repo: github.com/abelgomezc/abelgomezc                     ║
  ╚══════════════════════════════════════════════════════════════╝
-->
...
<!-- ════════════════════ WAVING HAND TITLE ════════════════════ -->
<h1>
  Hi there <img src="https://raw.githubusercontent.com/MartinHeinz/MartinHeinz/master/wave.gif" width="32px"> I'm Abel
</h1>

<!-- ════════════════════ TYPING SVG ════════════════════ -->
<a href="https://github.com/abelgomezc">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=3000&pause=600&color=4DA8DA&center=true&vCenter=true&width=720&lines=Backend+Developer+%7C+Full+Stack+%F0%9F%92%BB;Java+%26+Spring+Boot+Enthusiast+%E2%98%95;PHP+%26+Symfony+%7C+Oracle+PL%2FSQL+%F0%9F%93%8A;Microservices+%7C+Kafka+%7C+gRPC+%E2%9A%A1;Building+enterprise+systems+that+scale+%F0%9F%9A%80;Passionate+Learner+%E2%9D%A4" alt="typing SVG" />
</a>
...
const abel = {
  ...
  currentlyLearning: ["Kubernetes", "Cloud Native", "System Design"],
  askMeAbout: ["Java", "Spring Boot", "PHP", "Oracle"],
  funFact: "I debug PL/SQL faster than I make coffee ☕",
};
```

- 🔭 **Currently:** Building enterprise systems with **Java/Spring Boot** and **Oracle PL/SQL**
- 🌱 **Diving deeper into:** Microservices, **Kafka**, **gRPC**, **DevSecOps**
- 💼 **Most recent role:** Backend Developer @ **Telconet** (Telcos Web CRM)
- 🌐 **Portfolio:** [abelgomezc.github.io/porfolio](https://abelgomezc.github.io/porfolio)
- 📫 **Reach me at:** [abelgomezcondo@gmail.com](mailto:abelgomezcondo@gmail.com)

<br clear="right"/>

<!-- ════════════════════ ANIMATED DIVIDER ════════════════════ -->
<img src="https://user-images.githubusercontent.com/74038190/212284087-bbe7e430-757e-4901-90bf-4cd2ce3e1852.gif" width="100%" height="3px"/>
...
<!-- ════════════════════ TECH STACK ════════════════════ -->
## <img src="https://media.giphy.com/media/QssGEmpkyEOhBCb7e1/giphy.gif" width="32px"> Tech Stack
...
<!-- ════════════════════ GITHUB STATS ════════════════════ -->
## <img src="https://media.giphy.com/media/RHWPKBZ5GjqfM2Uk1y/giphy.gif" width="32px"> GitHub Stats
...
<a href="https://github.com/abelgomezc">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=abelgomezc&theme=tokyonight&hide_border=true&background=0d1117&stroke=4DA8DA&ring=4DA8DA&fire=FFB000&currStreakLabel=4DA8DA" alt="GitHub Streak" />
</a>
...
<div align="center">
  <a href="https://github.com/abelgomezc">
    <img src="http://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=abelgomezc&theme=tokyonight" width="100%" alt="profile summary" />
  </a>
</div>
...
<!-- ════════════════════ TROPHIES ════════════════════ -->
## <img src="https://media.giphy.com/media/SqmkZ5IdwzTP2/giphy.gif" width="36px"> GitHub Trophies

<div align="center">
  <a href="https://github.com/ryo-ma/github-profile-trophy">
    <img src="https://github-profile-trophy.vercel.app/?username=abelgomezc&theme=tokyonight&no-frame=true&no-bg=true&column=7&margin-w=15&margin-h=15" alt="trophies" />
  </a>
</div>
...
<!-- ════════════════════ ACTIVITY GRAPH ════════════════════ -->
## <img src="https://media.giphy.com/media/IcGkqdUmYLFGE/giphy.gif" width="32px"> Activity Graph

<div align="center">
  <a href="https://github.com/ashutosh00710/github-readme-activity-graph">
    <img src="https://github-readme-activity-graph.vercel.app/graph?username=abelgomezc&bg_color=0d1117&color=4DA8DA&line=4DA8DA&point=ffffff&area=true&hide_border=true" alt="activity graph" />
  </a>
</div>
  ...
  <table>
    <tr>
      <td width="50%" valign="top" align="center">
        <h3>🚀 Microservices with Docker</h3>
        <p>
          <em>Two independent containerized microservices,<br/>communicating via Docker Compose.</em>
        </p>
        <p>
          <code>Java</code> · <code>Spring Boot</code> · <code>MySQL</code><br/>
          <code>PostgreSQL</code> · <code>Docker</code>
        </p>
      </td>
      <td width="50%" valign="top" align="center">
        <h3>🌌 NASA API Visualizer</h3>
        <p>
          <em>Web app consuming NASA public APIs<br/>(APOD, Mars Rover, EPIC).</em>
        </p>
        <p>
          <code>Angular</code> · <code>TypeScript</code><br/>
    ...
    <tr>
      <td width="50%" valign="top" align="center">
        <h3>📊 Django Basic ERP</h3>
        <p>
          <em>ERP system with authentication,<br/>admin modules and reporting.</em>
        </p>
        <p>
          <code>Python</code> · <code>Django</code><br/>
          <code>PostgreSQL</code> · <code>JavaScript</code>
        </p>
      </td>
      <td width="50%" valign="top" align="center">
        <h3>🏢 Telcos Web (Enterprise)</h3>
        <p>
          <em>Commercial process management with<br/>microservices architecture.</em>
        </p>
        <p>
          <code>Java</code> · <code>Symfony</code> · <code>Oracle</code><br/>
          <code>Kafka</code> · <code>gRPC</code>
        </p>
      </td>
    </tr>
  </table>
